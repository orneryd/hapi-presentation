/**
 * This file just loads all the *-routes.js files in any /plugins/<subdir>.
 *
 * This allows us to just require the /plugins folder and it will load all the *-routes.js files in the subfolders.
 *
 * @type {exports}
 */
